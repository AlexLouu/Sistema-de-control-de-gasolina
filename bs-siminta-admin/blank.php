...
if($estado=="pendiente")
{
     echo"<a href='datos.php?id=$fila[id]' class='list-group-item active'>"; 
    
    echo"<h4 class=list-group-item-heading>".$fila['nombre']."&nbsp;".$fila['apellidos']."</h4>"; 
   
    echo" <p class=list-group-item-text>".$fila['producto']."</p>";
  ...
  echo"</a>";
   ...
   echo"<a href='datos.php?id=$fila[id]' class='list-group-item'>";
      echo"<h4 class=list-group-item-heading>".$fila['nombre']."&nbsp;".$fila['apellidos']."</h4>"; 
        echo" <p class=list-group-item-text>".$fila['producto']."</p>";
